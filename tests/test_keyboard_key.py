...
def test_KeyboardKey():
    ...
    """
    next_key = {'w': 1, 'y': 0}
    kk = KeyboardKey('TEST', None, next_key, [1,1], 'FIXME: offset support')
...
def test_KeyboardKey_left_key():
    ...
    """
    next_key = {'w': 1, 'y': 0}
    kk_l = KeyboardKey('TEST_LEFT', None, next_key, [1,1], 'FIXME: offset support')
    kk = KeyboardKey('TEST_RIGHT', kk_l, next_key, [2,1], 'FIXME: offset support')
